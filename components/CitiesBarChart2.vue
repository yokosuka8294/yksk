...
type Data = {
  canvas: boolean
  chartData: typeof Data.cities2.data
  date: string
  cities: VueI18n.TranslateResult[]
}
type Methods = {}
type Computed = {
  displayData: {
...
> = {
  ...
  data() {
    const cities = [this.$t('陽性患者数')]
    const citiesData = Data.cities2.data
    citiesData.datasets.map(dataset => {
