<template>
  <div class="About">
    ...
    <static-card>
      ...
      {{
        $t(
          '横浜市による公式情報と客観的な数値をわかりやすく伝えることで、横浜市にお住まいの方や、横浜市内に拠点を持つ企業の方、横浜市を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}<br />
      <br />
      {{
        $t(
          'このサイトは、横浜市が管理しているものではありません。複製・改変が許されたオープンソースライセンスで公開されている、東京都公式新型コロナウイルス対策サイトの仕組みを利用しています。'
        )
      }}
    </static-card>
    <static-card>
