<template>
  <div class="About">
    ...
    <static-card>
      ...
      {{
        $t(
          '横須賀市による公式情報と客観的な数値をわかりやすく伝えることで、横須賀市にお住まいの方や、横須賀市内に拠点を持つ企業の方、横須賀市を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}<br />
      <br />
      {{
        $t(
          'このサイトは、横須賀市が管理しているものではありません。複製・改変が許されたオープンソースライセンスで公開されている、東京都公式新型コロナウイルス対策サイトの仕組みを利用しています。'
        )
      }}
    </static-card>
    <static-card>
    ...
    <static-card>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、当サイト開発者は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
    ...
    <static-card>
      <h3>
        {{
          $t(
            '「区別 陽性者人数マップ」に使用している横須賀市の地図データについて'
          )
        }}
      </h3>
      <p>
